...
const Forecast = ({ data }) => {
    ...
    const forecastDays = WEEK_DAYS.slice(dayInWeek, WEEK_DAYS.lenght).concat(WEEK_DAYS.slice(0, dayInWeek));
                        ...
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                <div className="daily-item">
                                    <img alt="weather" className="icon-small" src={`https://openweathermap.org/img/wn/${item.weather[0].icon}@2x.png`} />
